...
class saiL3NeighborTest : public saiL3Test
{
    public:
        ...
        static sai_object_id_t  default_bridge_port_id;
...
sai_object_id_t saiL3NeighborTest::default_bridge_port_id = 0;
...
void saiL3NeighborTest::SetUpTestCase (void)
{
    ...
    default_bridge_port_id = sai_l3_bridge_port_id_get (default_port);
...
TEST_F (saiL3NeighborTest, create_and_remove_on_vlan_rif)
{
    ...
    status = sai_test_neighbor_fdb_entry_create (p_mac_str, vlan_obj_id,
                                                 default_bridge_port_id);
    ...
    status = sai_test_neighbor_fdb_entry_remove (p_mac_str, vlan_obj_id);
